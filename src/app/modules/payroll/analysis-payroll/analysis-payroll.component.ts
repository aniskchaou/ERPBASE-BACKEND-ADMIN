...
@Component({
  selector: 'app-analysis-payroll',
  templateUrl: './analysis-payroll.component.html',
  styleUrls: ['./analysis-payroll.component.css']
})
export class AnalysisPayrollComponent implements OnInit {

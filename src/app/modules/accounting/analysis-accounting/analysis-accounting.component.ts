...
@Component({
  selector: 'app-analysis-accounting',
  templateUrl: './analysis-accounting.component.html',
  styleUrls: ['./analysis-accounting.component.css']
})
export class AnalysisAccountingComponent implements OnInit {

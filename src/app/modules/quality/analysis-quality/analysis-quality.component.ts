...
@Component({
  selector: 'app-analysis-quality',
  templateUrl: './analysis-quality.component.html',
  styleUrls: ['./analysis-quality.component.css']
})
export class AnalysisQualityComponent implements OnInit {

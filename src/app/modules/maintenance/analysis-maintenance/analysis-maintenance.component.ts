...
@Component({
  selector: 'app-analysis-maintenance',
  templateUrl: './analysis-maintenance.component.html',
  styleUrls: ['./analysis-maintenance.component.css']
})
export class AnalysisMaintenanceComponent implements OnInit {

...
@Component({
  selector: 'app-analysis-staff',
  templateUrl: './analysis-staff.component.html',
  styleUrls: ['./analysis-staff.component.css']
})
export class AnalysisStaffComponent implements OnInit {

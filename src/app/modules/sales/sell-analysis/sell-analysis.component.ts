...
@Component({
  selector: 'app-sell-analysis',
  templateUrl: './sell-analysis.component.html',
  styleUrls: ['./sell-analysis.component.css']
})
export class SellAnalysisComponent implements OnInit {

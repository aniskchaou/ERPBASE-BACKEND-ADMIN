...
@Component({
  selector: 'app-analysis-purshase',
  templateUrl: './analysis-purshase.component.html',
  styleUrls: ['./analysis-purshase.component.css']
})
export class AnalysisPurshaseComponent implements OnInit {

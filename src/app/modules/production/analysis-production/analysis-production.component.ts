...
@Component({
  selector: 'app-analysis-production',
  templateUrl: './analysis-production.component.html',
  styleUrls: ['./analysis-production.component.css']
})
export class AnalysisProductionComponent implements OnInit {

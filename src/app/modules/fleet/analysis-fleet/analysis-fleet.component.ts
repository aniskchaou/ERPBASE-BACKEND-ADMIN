...
@Component({
  selector: 'app-analysis-fleet',
  templateUrl: './analysis-fleet.component.html',
  styleUrls: ['./analysis-fleet.component.css']
})
export class AnalysisFleetComponent implements OnInit {
  constructor() { }

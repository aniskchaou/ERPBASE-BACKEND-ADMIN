...
@Component({
  selector: 'app-analysis-fix',
  templateUrl: './analysis-fix.component.html',
  styleUrls: ['./analysis-fix.component.css']
})
export class AnalysisFixComponent implements OnInit {
